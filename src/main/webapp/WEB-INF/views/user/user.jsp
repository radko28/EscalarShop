...
<h3>${user.username}</h3>
  ...
  <form:form commandName="user" method="post">
    ...
    <table>
    	...
    	<%-- 	<td><form:label	for="oldpassword" path="oldpassword"><spring:message code="password"/> *</form:label> </td>
    	...
    	<tr>
			<td><%-- <form:label	for="birthdateString" path="birthdateString"><spring:message code="admin.users.table.bd"/> *</form:label> --%></td>
